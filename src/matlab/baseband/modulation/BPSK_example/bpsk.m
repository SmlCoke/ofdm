...
%而16QAM的1111，调制后变成i=3，q=3，求出来能量为18，1110求出来是10
% BPSK，QPSK所有符号能量完全相同；16QAM，64QAM符号能量有差别，外圈与内圈的每bit能量不同，其平均能量为10
        spow=sum(ich3.*ich3+qch3.*qch3)/nd;  % sum: built in function
% dB转线性。10lg，注意有个负号，因为右侧等式是信号能量，不加负号的话，算出来的是Eb/N0，而不是N0/Eb。sr/br，是为了得到N0/Es
% 这里没有问题，关键在于我16QAM和64QAM解调时使用了==3，==-1，加了高斯噪声之后就基本不会等于这个值，导致ber高，应该用范围判定。
